                                    ...
                                    <form onSubmit={handleSubmit(onSubmit)} >
                                        <div className="row">
                                            <div className="col">
                                                ...
                                                <input type="text" className="form-control" placeholder="Nombre" aria-label="Nombre" value = {parkingInfo.name} {...register('name',{required:true})}/>
                                            </div>
                                            <div className="col">
                                            ...
                                            <div className="col">
                                                ...
                                                <input type="text" className="form-control" placeholder="Ubicación" aria-label="Ubicación" value = {parkingInfo.location} {...register('location',{required:true})}/>
                                            </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col">
                                                ...
                                                <input type="text" className="form-control" placeholder="Espacios disponibles" aria-label="Espacios disponibles" value = {parkingInfo.slotsAvailable} {...register('slots',{required:true})}/>
                                            </div>
